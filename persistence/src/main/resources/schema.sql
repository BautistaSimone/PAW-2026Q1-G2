...
ALTER TABLE products ADD COLUMN IF NOT EXISTS record_label VARCHAR(255) NOT NULL DEFAULT '';
ALTER TABLE products ADD COLUMN IF NOT EXISTS catalog_number VARCHAR(255) NOT NULL DEFAULT '';
ALTER TABLE products ADD COLUMN IF NOT EXISTS edition_country VARCHAR(255) NOT NULL DEFAULT '';
